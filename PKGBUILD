...
source_x86_64=("envviewer.tar.gz")
...
sha256sums_x86_64=("5c76f1a3e792131fc4502e5f299b718b8652b282bb8a40abdcccd9ebb30ccfab")   # 不定架构的软件来源的 hash，下文将介绍用
package() {

  install -dm755 ${pkgdir}/usr/bin
  install -Dm755 ${srcdir}/envviewer/build/unknown-Release/envviewer ${pkgdir}/usr/bin/envviewer # srcdir 变量是软件来源解压后的目录
}
